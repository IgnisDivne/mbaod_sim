...
#Created 2016-09-01 at 11:58

rplots.level <- 1
xpose.runno <- ''
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
pdf.title <- 'execute diagnostic plots sim.mod'
working.directory<-'C:/Users/erist836/Documents/GitHub/mbaod_sim/non-linear/modelfit_dir11/'
raw.results.file <- 'raw_results_sim.csv'
model.directory<-'C:/Users/erist836/Documents/GitHub/mbaod_sim/non-linear/propofol_run_run_dir_9/rep_1/cohort_3/'
model.filename<-'sim.mod'
