...
stop_critX_2 <- function(cohort_num,cohort_res,option=1,nsim=10000, CL_thetas=c(1,3),V_thetas=2,sim_params=loglin_size_mat_scaling, age_space = c(1,2,3,4,5,6),allow_next=T,power=F){
  library(mvtnorm)
